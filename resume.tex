...
%-------------------------------------------
    ...
    {Backend Developer}{December 2023 -- Present}
        \resumeItemListStart
            ...
            \resumeItem{Promoted the adoption of \textbf{Docker} and \textbf{db migrations}, resulting in a \textbf{60\%} improvement in deployment processes.}
        \resumeItemListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Final (Fourth) year, CGPA 8.8}{2020 -- Expected. 2024}
